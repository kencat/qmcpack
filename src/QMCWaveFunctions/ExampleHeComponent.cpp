...
ExampleHeComponent::FullPrecValueType ExampleHeComponent::calcRatio(ParticleSet& P, int iat)
{
  ...
  return std::exp(static_cast<FullPrecValueType>(log_v_new - log_v_old));
}
