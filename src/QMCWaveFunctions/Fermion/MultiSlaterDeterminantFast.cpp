...
MultiSlaterDeterminantFast::MultiSlaterDeterminantFast(ParticleSet& targetPtcl,
    ...
    : C2node_up(nullptr),
      ...
      RatioAllTimer("MultiSlaterDeterminantFast::calcRatio(all)"),
...
WaveFunctionComponent::FullPrecValueType MultiSlaterDeterminantFast::calcRatio(ParticleSet& P, int iat)
{
  if (usingBF)
  {
